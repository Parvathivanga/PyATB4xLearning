#Homework -13/08/2024
#Task 1- Can you create a program i will give you the number (user input & print table)
#f"{}" string format concept
#user will input-num int-> 10,100,-1,-2,2.3.14
#output should be
#9*1=9
#9*2=18 until 10.

num=input("Enter the number to create  table")
table=int(n
